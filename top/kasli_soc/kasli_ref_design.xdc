...
set_property PACKAGE_PIN R6 [get_ports clk_125m_pllref_p_i]
set_property PACKAGE_PIN R5 [get_ports clk_125m_pllref_n_i]
...
create_clock -name clk_ref_125m -period 8.0 [get_nets clk_ref_125m_p]
