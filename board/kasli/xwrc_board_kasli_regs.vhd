...
-- Generated on Wed Nov 06 17:49:18 2024 by roliveira
...
begin
  ...
  -- Register DEBUG
  wrpc_kasli_regs_o.DEBUG <= DEBUG_reg;
  DEBUG_wack <= DEBUG_wreq;
  process (clk_i) begin
    if rising_edge(clk_i) then
      if rst_n_i = '0' then
        DEBUG_reg <= "00010001001000100011001101000100";
      else
  ...
  process (wr_adr_d0, wr_req_d0, RESET_wack, SYSTEM_CLOCK_wack, DEBUG_wack) begin
    RESET_wreq <= '0';
    SYSTEM_CLOCK_wreq <= '0';
    DEBUG_wreq <= '0';
  ...
  process (wb_adr_i, rd_req_int, RESET_WRPC_CORE_reg, SYSTEM_CLOCK_SELECT_reg,
           DEBUG_reg) begin
